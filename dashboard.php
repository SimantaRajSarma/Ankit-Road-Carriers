...
$sql = "SELECT COUNT(*) AS total_driver FROM driver"; 
$result = $conn->query($sql);

if ($result->num_rows > 0) {
$row = $result->fetch_assoc();
$total_vehicle = $row["total_driver"];
echo $total_vehicle;
} else {
echo "0"; 
}
...
$sql = "SELECT COUNT(*) AS total_party FROM party"; 
$result = $conn->query($sql);

if ($result->num_rows > 0) {
$row = $result->fetch_assoc();
$total_party = $row["total_party"];
echo $total_party;
} else {
echo "0"; 
}
...
?>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Recent LR's <span>| Today</span></h5>

    ...
    <table class="table table-bordered text-center" style="border: 2px solid  #4682B4; color: #4682B4;">
        ...
        <tbody>
            <tr>
                ...
                <td class="fw-bold">Total Freight<br>GST Tax<br>Loading Charges<br>Bilty Charges<br>Detention Charges<br>Advance<br>Balance</td>
                <td><?php echo $bill_freight; ?><br>0.00<br>0.00<br>0.00<br>0.00<br>0.00<br><?php echo $bill_freight; ?></td>
...
function PrintResult() {
  ...
  // Hide the header by adding a specific class or ID
  var header = document.getElementById('header');
  header.classList.add('print-hide'); // Assuming you add a class 'print-hide' to the header
